...
Vue.component('sharp-custom-map', _Map2.default);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-59420a4b", Component.options)
  } else {
    hotAPI.reload("data-v-59420a4b", Component.options)
  }
...
var render = function() {
  ...
  return _c("div", [_vm._v("Sharp Map")])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-59420a4b", module.exports)
  }
}
